...
(defun quantize (pitch-in &optional (pc *scale*))
  (labels ((lp (inc pitch)
...
(defun make-chord (lower upper number &optional (pc *scale*))
  (let ((chord '()))
    (labels ((lp (l u n p)
...
(defun quantize-list (lst &optional (pc *scale*))
  (mapcar #'(lambda (i) (quantize i pc)) lst))

(defun q-list (start end &optional (scale *scale*) keep-duplicate-p )
